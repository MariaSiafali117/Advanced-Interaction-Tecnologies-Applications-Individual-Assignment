...
Σε αυτό το μάθημα μας δίνεται η ευκαιρία να μάθουμε και να εξερευνήσουμε το πρόγραμμα του Processing. Το πρόγραμμα αυτό έχει πολλές δυνατότητες και μπορούμε να δημιουργήσουμε εμδιαφέροντες αλληλεπιδράσεις χρησιμοποιώντας ταυτόχρονα κάμερα, εικόνες και φηφιακά μέσα. Χρησιμοποιώντας το βιβλίο του Shiffman μπορούμε να πάρουμε μερικά παραδείγματα να τα επεξεργαστούμε και να φτιάξουμε κάτι δικό μας.

# Summary

Σε αυτή την άσκηση έπρεπε με την χρήση της κάμερας να αναγνωρήσει εικόνες, τις κινήσεις του σώματος μας ακόμα και QRcode προκειμένου να εκτελέσει τις εντολές που του έχουμ ορίσει. Επίσης συνδυάζοντας έτοιμες βιβλιοθήκες μπορούμε να ψηφοποιοήσουμε μερικές καταστάσεις όπως για παράδειγμα στο τρίτο παραδοτέο όπου χρειάζεται να επεξεργαστούμε μία εικόνα με εντολές που έχουμε ορίσει στα κουτάκια της βιβλιοθήκης ή σε άλλες φωτογραφίες. 
...
### <li> Το κουτάκι νούμερο 4, πατώντας δεζί κλικ και περιστρέφοντας περιστρέφει την εικόνα </li>
...
Επιλέγοντας τον προσομοιωτή η διαδικασία γίνεται πιο γρήγορα και εύκολα. Ο προσωμοιωτής περιέχει έναν ήδη έτοιμο κώδικα που αναπαριστά το τραπέζι καθώς έχει αναπαραστήσει και τα  fiducials (κουτάκια γύρο του) και  ο κάθε χρήστης μπορεί να τον προσαρμώσει ανάλογα με το τι θέλει να δημιουργήσει.  Σε αντίθεση με την κάμερα που μπορεί να κάνει την διαδικασία πιο χρονοβόρα. Παρόλα αυτά και η χρήση κάμερας φαίνεται να είναι αποτελεσματική.
...
Με αυτή την άσκηση είδαμε πόσες λειτουργίες μπορούμε να εφαρμόσουμε μέσα από το πρόγραμμα του Processing. Μπορέσαμε να βάλουμε ένα βίντεο σαν backgroud ανοίγωντας την κάμερα, δείχνοντας το QRcode μπορέσαμε να μεταβούμε στην αντίστοιχη ιστοσελίδα που είχαμε αποθηκεύσει στο QR. Επιπλόν ρυθμίσαμε την κάμερα ώστε να επεξεργαστεί την εικόνα μας και να αλληλεπιδράσει μαζί μας είτε βάζοντας περίγραμμα γύρω μας, είτε ακολουθώντας τις κινήσεις του σώματος μας, είτε ακολουθώντας κάποιο αντικείμενο εμφανίζοντας χρώματα στην οθόνη. Τέλος είδαμε πως μπορούμε να μορφωποιήσουμε μία εικόνα με εντολές που έχουμε ορίσει σε άλλα μέσα μέσω διαφορετικής εφαρμογής.  
